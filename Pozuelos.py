...
from src.BW2_calculations.lcia_impact_assessment import saving_LCA_results,print_recursive_calculation, saving_sensitivity_results
...
if __name__ == '__main__':
    ...
    project = f'{site_name}_test_water'

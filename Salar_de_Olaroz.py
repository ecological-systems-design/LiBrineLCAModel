...
if __name__ == '__main__' :
    ...
    # for i in range(1,24) :
    #     project_old = f'Site_{site_name}_sensitivity_{i}'
    ...
    process_sequence = [
        ...
        washing_TG(),
        dissolution(),
        Centrifuge_general(DEFAULT_CONSTANTS,{},custom_name = "df_centrifuge_general_second"),
    ...
    process_sequence = [
        ...
        washing_TG(),
        dissolution(),
        Centrifuge_general(DEFAULT_CONSTANTS,SENSITIVITY_RANGES,custom_name="df_centrifuge_general_second"),
        ion_exchange_H(custom_name=None),
        ion_exchange_H(custom_name="df_ion_exchange_H_second"),
        ion_exchange_L(),
        Liprec_BG(),
    ...
    # # print(impacts)
    #
    # Visualization.plot_impact_categorie
    #     # saving_LCA_results(impacts, abbrev_loc)
    #     #
    #     # # Plot the resultss(impacts, abbrev_loc)
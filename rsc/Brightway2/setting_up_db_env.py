...
from rsc.Brightway2.lithium_site_db import check_database, copy_database
...
def database_environment(biosphere, ei_path, ei_name, site_name, deposit_type, country_location, eff,
                         Li_conc, op_location, abbrev_loc):
    ...
    site_db = check_database(site_name, country_location, eff, Li_conc, op_location, abbrev_loc, ei_name,
                   biosphere)
